      ...
      <div className="w-full max-w-xl p-8 card bg-white/80 backdrop-blur-xl border border-white/50 shadow-2xl rounded-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-slate-800 to-slate-600">Welcome Aboard!</h1>
            <p className="text-slate-500 mt-2">Let's setup your 30-day onboarding journey.</p>
          </div>
